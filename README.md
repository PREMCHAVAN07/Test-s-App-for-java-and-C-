...
{     
	...
	PageTwo(String s)
	{
		 ...
		 setContentPane(new JLabel(new ImageIcon("G:/aa.jpg")));
		bg=new ButtonGroup();
                             ...
                             catch(IOException e)
	                     	{
	                          e.printStackTrace();
                                ...
                                JButton b=new JButton("Click Me");  
          	               	...
          	               	h.setFont(new Font("Couier New",Font.BOLD,22));h.setForeground(Color.GRAY);
          	                	
                                f.add(b);f.add(h);h.setBounds(50,20,300,50);
...
[3].setText("None of Above");
		...
		if(current==8)
		{
			...
			jb[0].setText("XYZ object=new XYZ");jb[1].setText("XYZ object=new XYZ();");jb[2].setText("XYZ object=new XYZ[];");jb
[3].setText("None of  above");
		}
		if(current==9)
		{
...
{	
	...
	void set()
	{
		...
		if(current==2)
		{
			...
			jb[0].setText("Student[] s=new Person[4]");jb[1].setText("Student s[3];");jb[2].setText("Student[] s[]");jb[3].setText
("Student p[][]=new Person[5][]");
		}
		if(current==3)
		{
...
{	
	...
	void set()
	{
		...
		if(current==1)
		{
			...
			jb[0].setText("Dynamic or runtime polymorphism");jb[1].setText("Static or compile time polimorphism");jb[2].setText
("Encapsulation");jb[3].setText("None of above");
		}
		if(current==2)
		{
		...
		if(current==3)
		{
			...
			jb[0].setText("translated to.java file");jb[1].setText("compiled to.java file");jb[2].setText("translated to servlet");jb
[3].setText("both a and c");
		}
		if(current==4)
		{
...
{	
	...
	{jb[4].setSelected(true);
		...
		if(current==3)
		{
			...
			jb[0].setText("int ~Country()");jb[1].setText("void Country()");jb[2].setText("int ~Country(Country obj)");jb[3].setText
("void ~Country()");
		}
		if(current==4)
		{
		...
		if(current==6)
		{
			...
			jb[0].setText("Type definitions (typedefs)");jb[1].setText("Class definitions");jb[2].setText("Function definitions");jb
[3].setText("Template definitions");
		}
		if(current==7)
		{
...
{	
	...
	{jb[4].setSelected(true);
		...
		if(current==2)
		{
			...
			jb[0].setText("‘has-a’ relationship");jb[1].setText("‘is-a’ relationship");jb[2].setText("association relationship");jb
[3].setText("none of the above");
		}
		if(current==3)
		{
		...
		if(current==9)
		{
			...
			jb[0].setText("Exception Handling");jb[1].setText("Reflection");jb[2].setText("Operator Overloading");jb[3].setText
("Namespaces");
		}
		l.setBounds(30,40,450,20);
		for(int i=0,j=0;i<=90;i+=30,j++)
